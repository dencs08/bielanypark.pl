...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Dziękujemy za kontakt z bielanypark!</title>
    <style type="text/css">
            ...
            <table role="presentation" width="100%" style="border-spacing:0;">
              <tr>
                <td style="padding:0;">
                    ...
                    <h1 style='font-family:"Cormorant", serif; font-size:24px;'>Hej {!! $name !!}!</h1>
                    <h2 style='font-family:"Cormorant", serif; font-size:20px;'>
                        Dziękujemy za kontakt z nami, odezwiemy się
                        niedługo.
                    </h2>
                    <p style='font-family:"Poppins", sans-serif; font-size:16px;'>Do usłyszenia!</p>
                </td>
              </tr>
            </table>
          </td>
